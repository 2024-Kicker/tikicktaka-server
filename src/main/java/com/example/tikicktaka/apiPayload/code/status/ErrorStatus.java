...
public enum ErrorStatus implements BaseErrorCode {
    ...
    MEMBER_SMS_AUTH_EXPIRED(HttpStatus.BAD_REQUEST, "MEMBER4005", "만료된 인증번호입니다."),
    MEMBER_SMS_AUTH_INVALID(HttpStatus.BAD_REQUEST, "MEMBER4006", "인증번호가 일치하지 않습니다."),
    MEMBER_SMS_AUTH_NOT_VERIFIED(HttpStatus.BAD_REQUEST, "MEMBER4007", "본인인증을 먼저 진행해주세요."),
    MEMBER_EMAIL_NOT_FOUND(HttpStatus.BAD_REQUEST, "MEMBER4008", "이메일이 존재하지 않습니다."),
    MEMBER_EMAIL_AUTH_ERROR(HttpStatus.BAD_REQUEST, "MEMBER4009", "이메일 인증에 실패했습니다. 인증 코드와 이메일을 확인해주세요."),
    MEMBER_NOT_FOUND(HttpStatus.BAD_REQUEST, "MEMBER4010", "존재하지 않는 회원입니다."),
    MEMBER_TEAM_NOT_FOUND(HttpStatus.NOT_FOUND, "MEMBER4011", "존재하지 않는 사용자 선호팀 정보입니다."),
    MEMBER_DIBS_NOT_FOUND(HttpStatus.NOT_FOUND, "MEMBER4012", "존재하지 않는 찜 내역입니다."),
